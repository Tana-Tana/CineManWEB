...
<body>
    ...
    <script>
        function validatePassword() {
            ...
            var errorP = document.querySelector(".container .error-message");

            errorP.textContent = "${requestScope.error != null ? requestScope.error : ''}";

            if (password !== confirmPassword) {
                errorP.textContent = "Mật khẩu xác nhận không khớp!";
                return false;
            }
            return true;
        }
